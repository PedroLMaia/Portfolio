      ...
      <div className="flex flex-col text-center items-center justify-center my-10 py-16 sm:py-32 md:py-30 md:flex-row md:space-x-4 md:text-left">
        ...
        <div className="md:mt-2 md:w-3/5">
          ...
          <Link
            ...
            className="bg-gray-800 text-neutral-100 rounded shadow inline-block hover:-translate-y-1 transition-transform cursor-pointer hover:text-neutral-100 hover:bg-gray-900 dark:bg-neutral-200 dark:text-black dark:hover:text-black dark:hover:bg-neutral-100 font-semibold px-6 py-3"
            activeClass="active"
            spy={true}
            smooth={true}
            offset={-100}
